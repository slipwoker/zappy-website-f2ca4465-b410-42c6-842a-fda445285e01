document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    function clearFieldState(field) {
      ...
      const errorEl = field.parentElement ? field.parentElement.querySelector('.error-message') : null;
      if (errorEl) errorEl.textContent = '';
    }
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "720 משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'f2ca4465-b410-42c6-842a-fda445285e01',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'f2ca4465-b410-42c6-842a-fda445285e01';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'f2ca4465-b410-42c6-842a-fda445285e01';
